...
type
  TForm5 = class(TForm)
    ...
    CardsTableid: TWideStringField;
    CardsTablecheckItemStates: TWideStringField;
    CardsTableclosed: TWideStringField;
    CardsTabledateLastActivity: TWideStringField;
    CardsTabledescData: TWideStringField;
    CardsTableidBoard: TWideStringField;
    CardsTableidList: TWideStringField;
    CardsTableidMembersVoted: TWideStringField;
    CardsTableidShort: TWideStringField;
    CardsTableidAttachmentCover: TWideStringField;
    CardsTablemanualCoverAttachment: TWideStringField;
    CardsTableidLabels: TWideStringField;
    CardsTablename: TWideStringField;
    CardsTablepos: TWideStringField;
    CardsTableshortLink: TWideStringField;
    CardsTablebadges: TWideStringField;
    CardsTabledue: TWideStringField;
    CardsTableidChecklists: TWideStringField;
    CardsTableidMembers: TWideStringField;
    CardsTablelabels: TWideStringField;
    CardsTableshortUrl: TWideStringField;
    CardsTablesubscribed: TWideStringField;
    CardsTableurl: TWideStringField;
    CardsTableattachments: TWideStringField;
    CardsTabledesc: TWideMemoField;
    ListsTableid: TWideStringField;
    ListsTablename: TWideStringField;
    ListsTableclosed: TWideStringField;
    ListsTableidBoard: TWideStringField;
    ListsTablepos: TWideStringField;
    ListsTablesubscribed: TWideStringField;
    LabelsTableid: TWideStringField;
    LabelsTableidBoard: TWideStringField;
    LabelsTablename: TWideStringField;
    LabelsTablecolor: TWideStringField;
    LabelsTableuses: TWideStringField;
